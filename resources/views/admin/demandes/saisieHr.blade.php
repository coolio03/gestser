    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Saisie des demandes</li>
            </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                @if (count($demandes))
                    @foreach ($demandes as $dde)
                        ...
                        <tr>              
                            ...
                            <td>
                                @if ($dde->date_saisir_hr == null)
                                
                                @else 
                                {{date('d/m/Y',strtotime($dde->date_saisir_hr))}}
                                @endif    </td>
                            <td @if ($dde->date_saisir_hr == null)
                                style="background-color: silver"
                            @else
                                style="background-color: lime"
                            @endif> 
                                @if ($dde->date_saisir_hr == null)
                                Pas encore Saisie Hr
                                @else 
                                 Saisie dans Hr
                                @endif    
                            </td>
