...
<!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-32">
    <!-- Brand Logo -->
    <a href=" {{ route('cadre') }} " class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            <a href="{{route('cadre')}}" class="nav-link @if(!$segment)
            active
          @endif">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href=" {{route('cadre.collaborateurs.create')}} " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter</p>
                </a>
              </li>
              <li class="nav-item">
                <a href=" {{ route('cadre.collaborateurs.index')}} " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Lister</p>
                </a>
              </li>
          ...
          @endif ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href=" {{route('cadre.demandes.index')}} " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
