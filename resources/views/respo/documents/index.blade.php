                        ...
                        <tr>              
                            ...
                            <td>
                               ...
                               <a class="btn btn-warning" data-toggle="modal" id="redigeButton"  class="btn btn-success" data-target="#redigeModal" data-attr="{{route('noteEmbauche', $dde->id)}} " title="Note d'information embauche">
                                ...
                                <a class="btn btn-success" data-toggle="modal" id="redigeButton"  class="btn btn-success" data-target="#redigeModal" data-attr=" {{route('renouvellementEmbEssai')}} " title="Lettre renouvellement periode essai ">
                                    <i class="nav-icon fas fa-file"></i>
                                </a>
                               @endif
