                        ...
                        <tbody>
                            ...
                            @foreach ($collaborateurs as $collabo)
                                ...
                                <tr>              
                                    ...
                                    <td> 
                                        <a href="{{route('cadre.collaborateurs.edit', $collabo->id)}}" class="btn btn-info" title="Editer Collaborateur de {{$collabo->nom.' '. $collabo->prenoms}}" > <i class="nav-icon fas fa-edit"></i>
                                        </a>
                                        &nbsp; 
