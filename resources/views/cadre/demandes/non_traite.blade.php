                ...
                @if (count($demandes))
                    @foreach ($demandes as $dde)
                        ...
                        <tr>              
                            ...
                            <td> 
                                <a href=" {{route('cadre')}} " class="btn btn-info" title="Modifier la demande de {{$dde->collaborateur->nom.' '. $dde->collaborateur->prenoms}}"> <i class="nav-icon fas fa-edit"></i></a>
                               &nbsp; 
                                @if (!$dde->responsable_id == null)
