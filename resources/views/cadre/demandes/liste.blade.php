...
<!-- Content Header (Page header) -->
  ...
  <!-- /.content-header -->
    ...
    <section class="content">
        ...
        <div class="card-body"> 
            <p>
                <a href=" {{route('cadre.demandes.create')}} " class="btn btn-primary"><i class="nav-icon fas fa-plus"></i>&nbsp;&nbsp;Ajouter une demande</a>
            </p>
                        ...
                        <tr>              
                            ...
                            <td> 
                                @if (!isset($dde->date_traitement))
                                    <a href=" {{route('cadre.demandes.edit', $dde->id)}} " class="btn btn-info" title="Modifier la demande de {{$dde->collaborateur->nom.' '. $dde->collaborateur->prenoms}}"> <i class="nav-icon fas fa-edit"></i></a>
                                ...
                                <form action="{{route('cadre.demandes.destroy', $dde->id)}}" method="POST">
                                    @method('DELETE')
