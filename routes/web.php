...
Route::namespace('Respo')->prefix('home')->middleware('auth')->group(function(){
    ...
    Route::get('/demandes/archive', 'DemandeController@archive',['as'=>'home'])->name('archives');
    Route::get('/demandes/nonArchive', 'DemandeController@nonArchive',['as'=>'home'])->name('nonArchives');
    ...
    Route::put('/document/{demande}/redigeReclassement', 'DocumentController@redigeReclassement',['as'=>'home'])->name('redigeReclassement');
    ...
    Route::get('/documents/rediger/{demande}/prorogation','DocumentController@prorogation',['as'=>'home'])->name('prorogation');
    Route::get('/documents/rediger/{demande}/reclassement','DocumentController@reclassement',['as'=>'home'])->name('reclassement');
