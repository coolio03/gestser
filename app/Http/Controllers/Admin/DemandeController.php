...
class DemandeController extends Controller
{
    ...
    {
        $arr['demandes'] = Demande::paginate(5);
    ...
    {
        $arr['demandes'] = Demande::whereNotNull('responsable_id')->paginate(5);
        $arr['users'] = User::all();
    ...
    {
        $arr['demandes'] = Demande::where('status','=',true)->paginate(5);
        return view('admin.demandes.complet')->with($arr);

    }
    public function nonComplet()
    {
        $arr['demandes'] = Demande::where('status','=',false)->paginate(5);
        return view('admin.demandes.complet')->with($arr);
    ...
    {
        $arr['demandes'] = Demande::whereNotNull('date_traitement')->paginate(5);
        $arr['users'] = User::all();
    ...
    {
        $arr['demandes'] = Demande::whereNull('date_traitement')->paginate(5);
        $arr['users'] = User::all();
    ...
    {
        $arr['demandes'] = Demande::whereNotNull('date_cloture')->where('visa',true)->paginate(5);
        $arr['users'] = User::all();
    ...
    {
        $arr['demandes'] = Demande::whereNull('date_cloture')->where('visa',true)->paginate(5);
        $arr['users'] = User::all();
        return view('admin.demandes.cloture')->with($arr);
    }
    ...
    {
        $arr['demandes'] = Demande::whereNotNull('date_transmission')->where('visa',true)->paginate(5);
        $arr['users'] = User::all();
        return view('admin.demandes.transmission')->with($arr);
    }
    public function nonTransmisClient()
    {
        $arr['demandes'] = Demande::whereNull('date_transmission')->where('visa',true)->paginate(5);
        return view('admin.demandes.transmission')->with($arr);
    }
    public function saisieHr()
    {
        $arr['demandes'] = Demande::whereNotNull('date_saisir_hr')->where('visa',true)->paginate(5);
        $arr['users'] = User::all();
        return view('admin.demandes.saisieHr')->with($arr);
    }
    public function nonSaisieHr()
    {
        $arr['demandes'] = Demande::whereNull('date_saisir_hr')->where('visa',true)->paginate(5);
        $arr['users'] = User::all();
        return view('admin.demandes.saisieHr')->with($arr);
    }
    ...
    {
        $arr['demandes'] = Demande::whereNull('responsable_id')->paginate(5);
        $arr['users'] = User::all();
    ...
    {
        $arr['demandes'] = Demande::where('visa',False)->whereNotNull('date_traitement')->paginate(5);
        return view('admin.demandes.visa')->with($arr);

    }
    public function signe()
    {
        $arr['demandes'] = Demande::where('visa',True)->paginate(5);
        return view('admin.demandes.visa')->with($arr);

    }
    public function nonArchive()
    {
        $arr['demandes'] = Demande::whereNull('date_archive')->where('visa',true)->paginate(5);
